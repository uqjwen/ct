...
// $Id: xx_mmu_regs.vp,v 1.25 2022/01/06 08:14:36 jizk Exp $
// *****************************************************************************
...
input   [`WK_PPN_WIDTH-1:0]  jtlb_tlbr_ppn;           
input   [`WK_VPN_WIDTH-1:0]  jtlb_tlbr_vpn;           
...
output  [`WK_SYSMAP_NUM*`WK_SYSREG_WIDTH-1:0] sys_regs_value; // 655=41*16-1
output  [15:0]  regs_jtlb_cur_asid;      
output  [13:0]  regs_jtlb_cur_flg;       
output          regs_jtlb_cur_g;         
output  [`WK_PPN_WIDTH-1:0]  regs_jtlb_cur_ppn;       
output          regs_mmu_en;       
output          mmu_sv48_en;      
output  [15:0]  regs_ptw_cur_asid;       
output  [`WK_PPN_WIDTH-1:0]  regs_ptw_satp_ppn;       
output  [15:0]  regs_tlboper_cur_asid;   
output  [2 :0]  regs_tlboper_cur_pgs;    
output  [`WK_VPN_WIDTH-1:0]  regs_tlboper_cur_vpn;    
...
reg     [40:0]  sys_regs[`WK_SYSMAP_NUM-1:0];
reg             sys_regs_op;
// &Wires; @26
wire            cp0_mmu_cskyee;          
wire            cp0_mmu_icg_en;          
...
wire            wdata_tlbwi;             
wire            wdata_tlbwr;             
wire   [40:0]   sys_regs_rst[`WK_SYSMAP_NUM-1:0];
wire   [63:0]   sys_reg_data;
...
//           .external_en(1'b0            ), @49
//           .module_en  (cp0_mmu_icg_en  ), @50
//           .local_en   (mmu_regs_clk_en ), @51
//           .clk_out    (mmu_regs_clk    ) @52
//          ); @53
...
//                  MMU Regs Definition
//==============================================================================
parameter MIR_NUM  = 3'd0;
parameter MEL_NUM  = 3'd1;
parameter MEH_NUM  = 3'd2;
parameter MCIR_NUM = 3'd3;
//----------------------------------------------------------
//                  Generate Write Enable
//----------------------------------------------------------
assign mir_write_en   = (cp0_mmu_reg_num[2:0] == MIR_NUM) && cp0_mmu_wreg;
assign mel_write_en   = (cp0_mmu_reg_num[2:0] == MEL_NUM) && cp0_mmu_wreg;
assign meh_write_en   = (cp0_mmu_reg_num[2:0] == MEH_NUM) && cp0_mmu_wreg;
assign mcir_write_en  = (cp0_mmu_reg_num[2:0] == MCIR_NUM) && cp0_mmu_wreg;
assign sysregs_write_en = (cp0_mmu_reg_num[2:0] == 3'b100) && cp0_mmu_wreg;
...
//                  sys_regs register
//==========================================================
assign sys_regs_rst[0]  = {`WK_SYSMAP_BASE_ADDR0, `WK_SYSMAP_FLG0};
assign sys_regs_rst[1]  = {`WK_SYSMAP_BASE_ADDR1, `WK_SYSMAP_FLG1};
assign sys_regs_rst[2]  = {`WK_SYSMAP_BASE_ADDR2, `WK_SYSMAP_FLG2};
assign sys_regs_rst[3]  = {`WK_SYSMAP_BASE_ADDR3, `WK_SYSMAP_FLG3};
assign sys_regs_rst[4]  = {`WK_SYSMAP_BASE_ADDR4, `WK_SYSMAP_FLG4};
assign sys_regs_rst[5]  = {`WK_SYSMAP_BASE_ADDR5, `WK_SYSMAP_FLG5};
assign sys_regs_rst[6]  = {`WK_SYSMAP_BASE_ADDR6, `WK_SYSMAP_FLG6};
assign sys_regs_rst[7]  = {`WK_SYSMAP_BASE_ADDR7, `WK_SYSMAP_FLG7};
assign sys_regs_rst[8]  = {`WK_SYSMAP_BASE_ADDR8, `WK_SYSMAP_FLG8};
assign sys_regs_rst[9]  = {`WK_SYSMAP_BASE_ADDR9, `WK_SYSMAP_FLG9};
assign sys_regs_rst[10] = {`WK_SYSMAP_BASE_ADDR10, `WK_SYSMAP_FLG10};
assign sys_regs_rst[11] = {`WK_SYSMAP_BASE_ADDR11, `WK_SYSMAP_FLG11};
assign sys_regs_rst[12] = {`WK_SYSMAP_BASE_ADDR12, `WK_SYSMAP_FLG12};
assign sys_regs_rst[13] = {`WK_SYSMAP_BASE_ADDR13, `WK_SYSMAP_FLG13};
assign sys_regs_rst[14] = {`WK_SYSMAP_BASE_ADDR14, `WK_SYSMAP_FLG14};
assign sys_regs_rst[15] = {`WK_SYSMAP_BASE_ADDR15, `WK_SYSMAP_FLG15};
assign sys_regs_rst[16]  = {`WK_SYSMAP_BASE_ADDR16, `WK_SYSMAP_FLG16};
assign sys_regs_rst[17]  = {`WK_SYSMAP_BASE_ADDR17, `WK_SYSMAP_FLG17};
assign sys_regs_rst[18] = {`WK_SYSMAP_BASE_ADDR18, `WK_SYSMAP_FLG18};
assign sys_regs_rst[19] = {`WK_SYSMAP_BASE_ADDR19, `WK_SYSMAP_FLG19};
assign sys_regs_rst[20] = {`WK_SYSMAP_BASE_ADDR20, `WK_SYSMAP_FLG20};
assign sys_regs_rst[21] = {`WK_SYSMAP_BASE_ADDR21, `WK_SYSMAP_FLG21};
assign sys_regs_rst[22] = {`WK_SYSMAP_BASE_ADDR22, `WK_SYSMAP_FLG22};
assign sys_regs_rst[23] = {`WK_SYSMAP_BASE_ADDR23, `WK_SYSMAP_FLG23};
assign sys_regs_rst[24]  = {`WK_SYSMAP_BASE_ADDR24, `WK_SYSMAP_FLG24};
assign sys_regs_rst[25]  = {`WK_SYSMAP_BASE_ADDR25, `WK_SYSMAP_FLG25};
assign sys_regs_rst[26] = {`WK_SYSMAP_BASE_ADDR26, `WK_SYSMAP_FLG26};
assign sys_regs_rst[27] = {`WK_SYSMAP_BASE_ADDR27, `WK_SYSMAP_FLG27};
assign sys_regs_rst[28] = {`WK_SYSMAP_BASE_ADDR28, `WK_SYSMAP_FLG28};
assign sys_regs_rst[29] = {`WK_SYSMAP_BASE_ADDR29, `WK_SYSMAP_FLG29};
assign sys_regs_rst[30] = {`WK_SYSMAP_BASE_ADDR30, `WK_SYSMAP_FLG30};
assign sys_regs_rst[31] = {`WK_SYSMAP_BASE_ADDR31, `WK_SYSMAP_FLG31};
always @(posedge mmu_regs_clk or negedge cpurst_b)begin 
  if(!cpurst_b)
    sys_regs_op <= 1'b0;
  else if(sysregs_write_en)
    sys_regs_op <= 1'b1;
  else if(sys_regs_op)
    sys_regs_op <= 1'b0;
end
...
generate
  for(genvar i=0; i<`WK_SYSMAP_NUM; i++)begin 
    always @(posedge mmu_regs_clk or negedge cpurst_b)begin 
      if(!cpurst_b)
        sys_regs[i] <= sys_regs_rst[i];
      else if(sysregs_write_en && (cp0_mmu_wdata[63:59] == i))
        sys_regs[i] <= cp0_mmu_wdata[PPN_WIDTH+5-1:0];
    end
  end
endgenerate
generate
  for(genvar i=0; i<PPN_WIDTH+5; i++)begin 
    wire [`WK_SYSMAP_NUM-1:0] sys_reg_data_tmp;
    for(genvar j=0; j<`WK_SYSMAP_NUM; j++)
      assign sys_reg_data_tmp[j] = (cp0_mmu_wdata[63:59] == j) & sys_regs[j][i];
    assign sys_reg_data[i] = |sys_reg_data_tmp[`WK_SYSMAP_NUM-1:0];
  end
endgenerate
assign sys_reg_data[63:PPN_WIDTH+5] = {64-PPN_WIDTH-5{1'b0}};

generate
  for(genvar i=0; i<`WK_SYSMAP_NUM; i++)
    assign sys_regs_value[i*41 +: 41] = sys_regs[i];
endgenerate
//==========================================================
//                  MIR register
//==========================================================
...
assign mel_data[63:0] = {mel_so,mel_c,mel_b,mel_sh,mel_sec,{49-PPN_WIDTH{1'b0}},
...
begin
  ...
  begin
    meh_vpn[VPN_WIDTH-1:0]   <= cp0_mmu_wdata[54:19];
...
assign meh_data[63:0] = {9'b0, meh_vpn[VPN_WIDTH-1:0], meh_pgs[PGS_WIDTH-1:0],
...
begin
  ...
  else if(satp_write_en && cp0_mmu_wdata[62:61] == 2'b0)//added sv48 @hcl
    satp_mode[3:0]            <= {cp0_mmu_wdata[63],2'b0,cp0_mmu_wdata[60]}; //added sv48 @hcl 
end
...
assign satp_data[63:0] = {satp_mode[3:0],satp_asid[ASID_WIDTH-1:0],
                          {60-PPN_WIDTH-ASID_WIDTH{1'b0}},satp_ppn[PPN_WIDTH-1:0]};


//==========================================================
//                  CP0 interface
//==========================================================
assign mmu_cp0_cmplt = tlboper_regs_cmplt || mcir_no_op || sys_regs_op;
...
always @( mcir_data[63:0]
       ...
       or meh_data[63:0]
       or mir_data[63:0]
       or sys_reg_data[63:0]
       or cp0_mmu_reg_num[2:0])
begin
  case(cp0_mmu_reg_num[2:0])
  ...
  3'b100    : mmu_cp0_data[63:0] = sys_reg_data[63:0];
...
assign regs_mmu_en                       = satp_mode[3:0] == 4'b1000 || satp_mode[3:0] == 4'b1001; //added sv48 @hcl 

assign mmu_sv48_en                       = satp_mode[3:0] == 4'b1001;

assign cp0_priv_mode[1:0]                = cp0_mmu_mprv ? cp0_mmu_mpp[1:0]
                                         : cp0_yy_priv_mode[1:0];
assign mmu_lsu_mmu_en                    = (satp_mode[3:0] == 4'b1000 || satp_mode[3:0] == 4'b1001) 
                                        && cp0_priv_mode[1:0] != 2'b11; //added sv48 @hcl
assign mmu_xx_mmu_en                     = (satp_mode[3:0] == 4'b1000 || satp_mode[3:0] == 4'b1001)
                                        && cp0_yy_priv_mode[1:0] != 2'b11; //added sv48 @hcl
