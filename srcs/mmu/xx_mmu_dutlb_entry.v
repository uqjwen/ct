...
// $Id: xx_mmu_dutlb_entry.vp,v 1.17 2022/01/06 08:14:36 jizk Exp $
// *****************************************************************************

// &ModuleBeg; @24
module xx_mmu_dutlb_entry(
  cp0_mmu_icg_en,
  cpurst_b,
  lsu_mmu_tlb_va,
  pad_yy_icg_scan_en,
...
//                  Entry Hit
//------------------------------------------------------------
assign utlb_hit0_sv39 =   utlb_req_vpn0[VPN_WIDTH-1-9:0] == utlb_vpn[VPN_WIDTH-1-9:0];
assign utlb_hit2_sv39 =   utlb_req_vpn2[VPN_WIDTH-1-9:0] == utlb_vpn[VPN_WIDTH-1-9:0];
assign utlb_hit3_sv39 =   utlb_req_vpn3[VPN_WIDTH-1-9:0] == utlb_vpn[VPN_WIDTH-1-9:0];
