...
// $Id: xx_mmu_iutlb.vp,v 1.55.32.1 2023/02/14 07:48:37 haozy Exp $
// *****************************************************************************
...
output  [`WK_VPN_WIDTH-1:0]  iutlb_arb_vpn;          
...
output  [`WK_PPN_WIDTH-1:0]  mmu_sysmap_pa2;         

// &Regs; @29
reg     [3 :0]  iutlb_fst_wen;          
reg             iutlb_miss;             
reg     [`WK_PPN_WIDTH-1:0]  iutlb_pa_buf;           
...
wire            entry0_upd;             
wire            entry0_vld;             
wire    [`WK_VPN_WIDTH-1:0]  entry0_vpn;             
...
wire            entry16_upd;            
wire            entry16_vld;            
wire    [`WK_VPN_WIDTH-1:0]  entry16_vpn;            
wire    [13:0]  entry17_flg;            
wire            entry17_hit;            
wire    [2 :0]  entry17_pgs;            
wire    [`WK_PPN_WIDTH-1:0]  entry17_ppn;            
wire            entry17_swp;            
wire            entry17_swp_on;         
wire            entry17_upd;            
wire            entry17_vld;            
...
wire    [`WK_PPN_WIDTH-1:0]  entry18_ppn;            
wire            entry18_swp;            
wire            entry18_swp_on;         
wire            entry18_upd;            
wire            entry18_vld;            
...
wire    [`WK_PPN_WIDTH-1:0]  entry19_ppn;            
wire            entry19_swp;            
wire            entry19_swp_on;         
wire            entry19_upd;            
wire            entry19_vld;            
...
wire    [`WK_PPN_WIDTH-1:0]  entry20_ppn;            
wire            entry20_swp;            
wire            entry20_swp_on;         
wire            entry20_upd;            
wire            entry20_vld;            
...
wire    [`WK_PPN_WIDTH-1:0]  entry21_ppn;            
wire            entry21_swp;            
wire            entry21_swp_on;         
wire            entry21_upd;            
wire            entry21_vld;            
...
wire    [`WK_PPN_WIDTH-1:0]  entry22_ppn;            
wire            entry22_swp;            
wire            entry22_swp_on;         
wire            entry22_upd;            
wire            entry22_vld;            
...
wire    [`WK_PPN_WIDTH-1:0]  entry23_ppn;            
wire            entry23_swp;            
wire            entry23_swp_on;         
wire            entry23_upd;            
wire            entry23_vld;            
...
wire    [`WK_PPN_WIDTH-1:0]  entry24_ppn;            
wire            entry24_swp;            
wire            entry24_swp_on;         
wire            entry24_upd;            
wire            entry24_vld;            
wire    [`WK_VPN_WIDTH-1:0]  entry24_vpn;            
wire    [13:0]  entry25_flg;            
wire            entry25_hit;            
wire    [2 :0]  entry25_pgs;            
wire    [`WK_PPN_WIDTH-1:0]  entry25_ppn;            
wire            entry25_swp;            
wire            entry25_swp_on;         
wire            entry25_upd;            
wire            entry25_vld;            
...
wire    [`WK_PPN_WIDTH-1:0]  entry26_ppn;            
wire            entry26_swp;            
wire            entry26_swp_on;         
wire            entry26_upd;            
wire            entry26_vld;            
...
wire    [`WK_PPN_WIDTH-1:0]  entry27_ppn;            
wire            entry27_swp;            
wire            entry27_swp_on;         
wire            entry27_upd;            
wire            entry27_vld;            
...
wire    [`WK_PPN_WIDTH-1:0]  entry28_ppn;            
wire            entry28_swp;            
wire            entry28_swp_on;         
wire            entry28_upd;            
wire            entry28_vld;            
...
wire    [`WK_PPN_WIDTH-1:0]  entry29_ppn;            
wire            entry29_swp;            
wire            entry29_swp_on;         
wire            entry29_upd;            
wire            entry29_vld;            
...
wire    [`WK_PPN_WIDTH-1:0]  entry30_ppn;            
wire            entry30_swp;            
wire            entry30_swp_on;         
wire            entry30_upd;            
wire            entry30_vld;            
...
wire    [`WK_PPN_WIDTH-1:0]  entry31_ppn;            
wire            entry31_swp;            
wire            entry31_swp_on;         
wire            entry31_upd;            
wire            entry31_vld;            
...
wire            entry8_upd;             
wire            entry8_vld;             
wire    [`WK_VPN_WIDTH-1:0]  entry8_vpn;             
...
wire    [`WK_PPN_WIDTH-1:0]  iutlb_hit_pa_fst;       
wire    [`WK_PPN_WIDTH-1:0]  iutlb_hit_pa_scd;       
...
wire            iutlb_off_hit;          
wire    [`WK_PPN_WIDTH-1:0]  iutlb_off_pa;           
wire    [2 :0]  iutlb_off_pgs;          
wire    [`WK_PPN_WIDTH-1:0]  iutlb_pa_aft_bypass;    
wire            iutlb_pa_vld;           
...
wire    [`WK_PPN_WIDTH-1:0]  utlb_swp_ppn;           
wire    [`WK_VPN_WIDTH-1:0]  utlb_swp_vpn;           
...
//           .external_en(1'b0          ), @51
//           .module_en  (cp0_mmu_icg_en), @52
//           .local_en   (iutlb_clk_en  ), @53
//           .clk_out    (iutlb_clk     ) @54
//          ); @55
...
assign mmu_ifu_sh       = iutlb_flg_aft_bypass[10] && !biu_mmu_smp_disable;
...
assign iutlb_va_illegal =(mmu_sv48_en ?  
(ifu_mmu_va[VPN_WIDTH+10] && !(&ifu_mmu_va[62:VPN_WIDTH+11]) || !ifu_mmu_va[VPN_WIDTH+10] &&  (|ifu_mmu_va[62:VPN_WIDTH+11])) 
:(ifu_mmu_va[VPN_WIDTH+1] && !(&ifu_mmu_va[62:VPN_WIDTH+2]) || !ifu_mmu_va[VPN_WIDTH+1] &&  (|ifu_mmu_va[62:VPN_WIDTH+2]) ))
                          && !iutlb_off_hit && ifu_mmu_va_vld; //sv48@hcl
assign iutlb_page_fault = (!iutlb_flg_aft_bypass[0]
                        ...
                        ||  iutlb_ref_pgflt
                        ||  iutlb_va_illegal) && !iutlb_off_hit 
                        && !jtlb_acc_fault;
...
// &Instance("xx_mmu_iplru","x_xx_mmu_iplru"); @155
xx_mmu_iplru  x_xx_mmu_iplru (
...
//           .module_en  (cp0_mmu_icg_en), @165
//           .local_en   (iplru_clk_en  ), @166
//           .clk_out    (iplru_clk     ) @167
//          ); @168
...
// &ConnRule(s/utlb_entry/entry0/); @364
// &Instance("xx_mmu_iutlb_fst_entry","x_xx_mmu_iutlb_entry0"); @365
xx_mmu_iutlb_fst_entry  x_xx_mmu_iutlb_entry0 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
...
// &ConnRule(s/utlb_entry/entry1/); @367
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry1"); @368
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry1 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry2/); @370
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry2"); @371
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry2 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry3/); @373
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry3"); @374
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry3 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry4/); @376
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry4"); @377
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry4 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry5/); @379
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry5"); @380
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry5 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry6/); @382
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry6"); @383
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry6 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry7/); @385
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry7"); @386
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry7 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry8/); @388
// &Instance("xx_mmu_iutlb_fst_entry","x_xx_mmu_iutlb_entry8"); @389
xx_mmu_iutlb_fst_entry  x_xx_mmu_iutlb_entry8 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry9/); @391
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry9"); @392
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry9 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry10/); @394
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry10"); @395
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry10 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry11/); @397
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry11"); @398
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry11 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry12/); @400
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry12"); @401
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry12 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry13/); @403
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry13"); @404
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry13 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry14/); @406
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry14"); @407
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry14 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry15/); @409
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry15"); @410
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry15 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry16/); @412
// &Instance("xx_mmu_iutlb_fst_entry","x_xx_mmu_iutlb_entry16"); @413
xx_mmu_iutlb_fst_entry  x_xx_mmu_iutlb_entry16 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry17/); @415
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry17"); @416
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry17 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry18/); @418
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry18"); @419
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry18 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry19/); @421
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry19"); @422
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry19 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry20/); @424
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry20"); @425
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry20 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry21/); @427
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry21"); @428
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry21 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry22/); @430
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry22"); @431
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry22 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry23/); @433
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry23"); @434
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry23 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry24/); @436
// &Instance("xx_mmu_iutlb_fst_entry","x_xx_mmu_iutlb_entry24"); @437
xx_mmu_iutlb_fst_entry  x_xx_mmu_iutlb_entry24 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry25/); @439
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry25"); @440
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry25 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry26/); @442
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry26"); @443
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry26 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry27/); @445
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry27"); @446
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry27 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry28/); @448
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry28"); @449
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry28 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry29/); @451
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry29"); @452
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry29 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry30/); @454
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry30"); @455
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry30 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
// &ConnRule(s/utlb_entry/entry31/); @457
// &Instance("xx_mmu_iutlb_entry","x_xx_mmu_iutlb_entry31"); @458
xx_mmu_iutlb_entry  x_xx_mmu_iutlb_entry31 (
  .cp0_mmu_icg_en          (cp0_mmu_icg_en         ),
  .cpurst_b                (cpurst_b               ),
  .lsu_mmu_tlb_va          (lsu_mmu_tlb_va         ),
  .pad_yy_icg_scan_en      (pad_yy_icg_scan_en     ),
...
assign utlb_upd_ppn[PPN_WIDTH-1:0] = cp0_mmu_pa_equal_va ? jtlb_utlb_ref_vpn[VPN_WIDTH-1:0]
                                   : jtlb_utlb_ref_ppn[PPN_WIDTH-1:0];
...
assign iutlb_addr_hit     = (iutlb_entry_hit[0]  || iutlb_entry_hit[8]
                          || iutlb_entry_hit[16] || iutlb_entry_hit[24]) && !iutlb_off_hit; 
...
//           .module_en  (cp0_mmu_icg_en), @826
//           .local_en   (pabuf_clk_en  ), @827
//           .clk_out    (pabuf_clk     ) @828
//          ); @829
...
//                  MUX the final pa 
//----------------------------------------------------------
//assign pa_drwk_sel = iutlb_bypass_hit || iutlb_off_hit || iutlb_scd;
