...
// $Id: xx_mmu_iutlb_entry.vp,v 1.11 2022/01/06 08:14:36 jizk Exp $
// *****************************************************************************

// &ModuleBeg; @24
module xx_mmu_iutlb_entry(
  cp0_mmu_icg_en,
  cpurst_b,
  lsu_mmu_tlb_va,
  pad_yy_icg_scan_en,
...
input   [`WK_PPN_WIDTH-1:0]  utlb_swp_ppn;           
input   [`WK_VPN_WIDTH-1:0]  utlb_swp_vpn;           
