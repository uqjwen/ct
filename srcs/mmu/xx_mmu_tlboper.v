...
// $Id: xx_mmu_tlboper.vp,v 1.35.32.1 2023/07/07 09:22:52 sitong.zhu Exp $
// *****************************************************************************

// &ModuleBeg; @24
module xx_mmu_tlboper(
  arb_tlboper_grant,
  cp0_mmu_icg_en,
  cp0_mmu_tlb_all_inv,
  cpurst_b,
...
input   [`WK_PPN_WIDTH-1:0]  regs_jtlb_cur_ppn;          
input   [15:0]  regs_tlboper_cur_asid;      
input   [2 :0]  regs_tlboper_cur_pgs;       
input   [`WK_VPN_WIDTH-1:0]  regs_tlboper_cur_vpn;       
...
output  [`MMU_DATA_WIDTH-1:0]  tlboper_arb_data_din;       
...
output  [`MMU_TAG_WIDTH-1:0]  tlboper_arb_tag_din;        
output  [`WK_VPN_WIDTH-1:0]  tlboper_arb_vpn;            
...
wire    [`WK_PPN_WIDTH-1:0]  tlb_ppn_aft_mask;           
wire            tlb_sm_idle;                
wire            tlb_tag_vld_in;             
wire            tlb_tlbp_cmplt;             
wire            tlb_tlbp_req;               
...
wire    [`WK_VPN_WIDTH-1:0]  tlb_vpn_aft_mask;           
...
wire            tlboper_clk_en;             
wire            tlboper_cmplt;              
wire    [`MMU_DATA_WIDTH-1:0]  tlboper_data_din;           
...
wire    [`MMU_TAG_WIDTH-1:0]  tlboper_tag_din;            
...
//           .local_en   (tlboper_clk_en  ), @55
//           .clk_out    (tlboper_clk     ) @56
//          ); @57
...
//index
// &Force("bus", "regs_tlboper_mir", 11, 0); @683
