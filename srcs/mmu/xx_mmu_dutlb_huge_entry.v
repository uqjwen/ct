//-----------------------------------------------------------------------------
// File          : xx_mmu_dutlb_huge_entry.v
...
// $Id: xx_mmu_dutlb_huge_entry.vp,v 1.3 2022/01/06 08:14:36 jizk Exp $
// *****************************************************************************

// &ModuleBeg; @24
module xx_mmu_dutlb_huge_entry(
  cp0_mmu_icg_en,
  cpurst_b,
  lsu_mmu_tlb_va,
  pad_yy_icg_scan_en,
...
input   [`WK_VPN_WIDTH-1:0]  utlb_req_vpn0;          
         
input   [`WK_VPN_WIDTH-1:0]  utlb_req_vpn2;          
input   [`WK_VPN_WIDTH-1:0]  utlb_req_vpn3;          
...
output          utlb_entry_hit2;        
output          utlb_entry_hit3;        
...
wire            utlb_entry_hit2;        
wire            utlb_entry_hit3;        
...
//                  Entry Hit
//------------------------------------------------------------
// &Force("bus", "utlb_req_vpn0", 26, 0); @116
// &Force("bus", "utlb_req_vpn1", 26, 0); @117

assign utlb_hit0_sv39 =   utlb_req_vpn0[VPN_WIDTH-1-9:18] == utlb_vpn[VPN_WIDTH-1-9:18];
assign utlb_hit2_sv39 =   utlb_req_vpn2[VPN_WIDTH-1-9:18] == utlb_vpn[VPN_WIDTH-1-9:18];
assign utlb_hit3_sv39 =   utlb_req_vpn3[VPN_WIDTH-1-9:18] == utlb_vpn[VPN_WIDTH-1-9:18];

assign utlb_hit0_sv48 =   (utlb_req_vpn0[VPN_WIDTH-1:VPN_WIDTH-9] == utlb_vpn[VPN_WIDTH-1:VPN_WIDTH-9]) && utlb_hit0_sv39;
assign utlb_hit2_sv48 =   (utlb_req_vpn2[VPN_WIDTH-1:VPN_WIDTH-9] == utlb_vpn[VPN_WIDTH-1:VPN_WIDTH-9]) && utlb_hit2_sv39;
assign utlb_hit3_sv48 =   (utlb_req_vpn3[VPN_WIDTH-1:VPN_WIDTH-9] == utlb_vpn[VPN_WIDTH-1:VPN_WIDTH-9]) && utlb_hit3_sv39;
//------------------------------------------------------------
//                  Output
//------------------------------------------------------------
assign utlb_entry_vld  = utlb_vld;
assign utlb_entry_hit0 = mmu_sv48_en ? utlb_hit0_sv48 : utlb_hit0_sv39;
assign utlb_entry_hit2 = mmu_sv48_en ? utlb_hit2_sv48 : utlb_hit2_sv39;
assign utlb_entry_hit3 = mmu_sv48_en ? utlb_hit3_sv48 : utlb_hit3_sv39;
